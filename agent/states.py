...
class TaskPlan(BaseModel):
    ...
    plan: Optional[Plan] = Field(None, description="The associated project plan")
...
class CoderState(BaseModel):
    ...
    project_dir: Optional[str] = Field(None, description="The absolute path to the generated project directory")